...
emails=Label(window,text="Enter your email here",font="time 24 bold")
emails.grid(row=0,column=0)
entry1=Entry(window)
entry1.grid(row=0,column=6)

password=Label(window,text="Enter your password here",font="time 24 bold")
password.grid(row=2,column=0)
entry2=Entry(window)
entry2.grid(row=2,column=6)

hashtag=Label(window,text="Enter your email here",font="time 24 bold")
